...
case "$POLLER" in
  nano-implementer|cheap-implementer|qwen-implementer|cursor-implementer|fallback-implementer)
...
while true; do
  ...
  case "$POLLER:$stage" in
    ...
    nano-implementer:implementing|cheap-implementer:implementing|qwen-implementer:implementing|cursor-implementer:implementing|fallback-implementer:implementing)
